...
var _RollerMetaLayer = _interopRequireDefault(require("../components/Map/layer/RollerMetaLayer"));
...
var RollerMap = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function RollerMap(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDrop", function (event) {
      ...
      var showData = _this.props.dragData;
    ...
    _defineProperty(_assertThisInitialized(_this), "location", function (showData) {
      ...
      if (showData.geometry) {
        ...
        showData.attributes.forEach(function (it) {
          if (it.field.name === 'centerPoint') {
            var centerPoint = JSON.parse(it.value);
  ...
  _createClass(RollerMap, [{
    ...
    value: function componentDidMount() {
      ...
      //订阅树节点拖拽事件
      this.pubsub_dragdata = PubSub.subscribe('setDragData', function (topic, dragData) {
        _this2.setState({
          dragData: dragData
        });
      });
    ...
    value: function render() {
      ...
      var sideMap = this.state.sideMap;
      var leftData = null;
      var rightData = null;
      ...
      }), dragData && leftData && /*#__PURE__*/_react["default"].createElement(_RollerMetaLayer["default"], {
        onRef: this.onLeftLayer,
        key: leftData.id,
        metaInfo: leftData
      }), dragData && rightData && /*#__PURE__*/_react["default"].createElement(_RollerMetaLayer["default"], {
        onRef: this.onRightLayer,
        key: rightData.id,
        metaInfo: rightData
      }), url && leftData && sideMap && /*#__PURE__*/_react["default"].createElement(_UrlLayer["default"], {
        onRef: this.onLeftLayer,
        key: 1,
        url: leftData
      }), url && rightData && sideMap && /*#__PURE__*/_react["default"].createElement(_UrlLayer["default"], {
        onRef: this.onRightLayer,
        key: 2,
        url: rightData
