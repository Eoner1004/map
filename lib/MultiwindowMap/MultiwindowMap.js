...
var MultiwindowMap = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function MultiwindowMap(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDrop", function (event) {
      ...
      var showData = _this.state.dragData;
      ...
      if (showData) {
        ...
        if (geometry) {
          ...
          _this.state.gxMap.locationPoint(point, zoom);
        }
      }
    });
  ...
  _createClass(MultiwindowMap, [{
    ...
    value: function componentDidMount() {
      ...
      //订阅树节点拖拽事件
      this.pubsub_dragdata = _pubsubJs["default"].subscribe('setDragData', function (topic, dragData) {
        _this2.setState({
          dragData: dragData
        });
      });
    ...
    value: function componentWillUnmount() {
      ...
      _pubsubJs["default"].unsubscribe(this.pubsub_dragdata);
    }
  }, {
    key: "onDragOver",
    ...
    value: function render() {
      ...
      var showDataList = this.state.showDataList.length ? this.state.showDataList : this.props.showDataList;
      ...
      }), dragData && showDataList && showDataList.length > 0 && showDataList.map(function (it) {
        return /*#__PURE__*/_react["default"].createElement(_MetaLayer["default"], {
          key: it.id,
          metaInfo: it
        });
      }), !dragData && showDataList && typeof showDataList !== 'string' && showDataList.length > 0 && showDataList.map(function (it, index) {
