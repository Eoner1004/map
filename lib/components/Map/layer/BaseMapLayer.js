...
var BaseMapLayer = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(BaseMapLayer, _React$PureComponent);

  var _super = _createSuper(BaseMapLayer);

  function BaseMapLayer(props) {
    var _this;
  ...
  _createClass(BaseMapLayer, [{
    key: "createBaseMapLayers",
    value: function createBaseMapLayers(serviceType, url) {
      var serviceLayer = null;

      if (serviceType === "esri") {// serviceLayer = esri.dynamicMapLayer({
        //     url: url,
        //     transparent: true,
        //     f: 'image',
        //     opacity: 0.8
        ...
        serviceLayer = _leaflet["default"].tileLayer(url, {
          maxZoom: 20,
          minZoom: 0
        });
      } else if (serviceType === 'wms') {// serviceLayer = L.tileLayer.wms(url, {
        //     layers: '',
        //     format: 'image/png',
        //     transparent: true,
        // });
      } else if (serviceType === 'wmts') {// serviceLayer =leaflet_wmts(url, {
        //         tileSize:256,
        //         layer: 'vec_c',
        //         style: "default",
        //         tilematrixSet: "c",
